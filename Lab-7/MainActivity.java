...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_username = (EditText)findViewById(R.id.r_username);
        et_password = (EditText)findViewById(R.id.r_password);
        et_cpassword = (EditText)findViewById(R.id.r_cpassword);
        btn_register = (Button)findViewById(R.id.rbtn_register);
